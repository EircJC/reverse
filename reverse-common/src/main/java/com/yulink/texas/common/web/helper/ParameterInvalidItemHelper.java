package com.yulink.texas.common.web.helper;
...
public class ParameterInvalidItemHelper {
    ...
    public static <T> List<ParameterInvalidItem> convertCVSetObjectToParameterInvalidItemList(
        Set<ConstraintViolation<T>> cvset) {
    ...
    public static List<ParameterInvalidItem> convertBindingResultToMapParameterInvalidItemList(
